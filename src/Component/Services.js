...
export default function Services() {
  ...
  <main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style={{backgroundimage: "url('assets/img/breadcrumbs-bg.jpg')"}}>
      ...
      {/* <ul class="list-group">
  <li class="list-group-item "><Link>link1</Link></li>
  <li class="list-group-item"><Link>link2</Link></li>
  <li class="list-group-item"><Link>link3</Link></li>
</ul> */}
{/* nested routing */}
    ...
    <section id="alt-services-2" class="alt-services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-around gy-4">
          ...
          <div class="col-lg-6 img-bg" style={{backgroundimage: "url('assets/img/alt-services-2.jpg')"}} data-aos="zoom-in"
